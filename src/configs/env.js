...
export const envVariables = {
  ...
  jwtSecret: process.env.JWTSECRET || "doanphanmem",
  tokenSecret: process.env.JWTSECRET || "doanphanmem",
  ...
  send_mail_path: process.env.SEND_MAIL_PATH || "http://localhost:5959",
  login_path: process.env.LOGIN_PATH || "http://localhost:3000",
};
